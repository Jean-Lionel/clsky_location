                            ...
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href="{{ route('properties.show', $property->id) }}">
                                        ...
                                        @endforeach
                                        {{-- <img src="{{ Storage::url($property->images->first()->image_path ?? '')  ?? '/img/property-4.jpg' }}"
                                             class="d-block w-100"
                                             alt="Image {{ $key + 1 }}"
                                             style="height: 400px; object-fit: cover;"> --}}
                                        {{-- <img class="img-fluid" src="{{ Storage::url($property->images->first()->image_path ?? '')  ?? '/img/property-4.jpg' }}" alt="{{ $property->title }}"> --}}
                                    </a>
                                ...
                                <div class="p-4 pb-0">
                                    ...
                                    <a class="d-block h5 mb-2" href="{{ route('properties.show', $property->id) }}">
                                        {{ $property->title }}
                                    </a>
                                    <p>
                                ...
                                <div class="d-flex border-top">
                                    <small class="flex-fill text-center border-end py-2">
                                        <i class="fa fa-ruler-combined text-primary me-2"></i>{{ $property->square_feet }} Sqft
                                    </small>
                                    <small class="flex-fill text-center border-end py-2">
