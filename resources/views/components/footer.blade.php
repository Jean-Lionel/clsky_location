...
<div class="container-fluid bg-dark text-white-50 footer pt-5 mt-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <h5 class="text-white mb-4">Sky Compony</h5>
                <p>Inscrivez-vous à Sky Compony newsletter pour recevoir les dernières nouvelles et mises à jour sur nos services. Ne manquez aucune offre spéciale!</p>
